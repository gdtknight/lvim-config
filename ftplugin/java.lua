...
local workspace_dir = home .. "/.jdtls-cache/" .. project_name
    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          ...
          {
            name = "JavaSE-19",
            path = "~/.sdkman/candidates/java/19.0.2-tem",
          },
        },
      },
      maven = {
...
config["on_attach"] = function(client, bufnr)
  ...
  map("n", "<leader>Jp", "<Cmd>JdtCompile<CR>", "Complete Compile")
  map("n", "<leader>Jb", "<Cmd>JdtBuildProject<CR>", "Build Project")
